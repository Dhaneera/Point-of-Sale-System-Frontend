        ...
        <div className='bg-white rounded-t-lg mb-10 w-[85%]'>
            ...
            <div className={`${toShow === true ? `grid grid-cols-4 max-lg:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1 px-5 font-sans w-full` : `hidden`}`}>
                ...
                <div className='flex  w-96  mt-[-8%]  items-center '>
                    <button className=' rounded-full h-12 border-2 px-5 mr-4 border-green-500 text-white font-bold  bg-green-800'> Add User</button>
                    <button className='rounded-full h-12 border-2 px-5 mr-4 border-blue-500 text-white font-bold  bg-blue-800'> Update User</button>
                </div>
            </div>
        </div>
    )
