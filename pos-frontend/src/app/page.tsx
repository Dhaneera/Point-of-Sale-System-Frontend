        ...
        <div className="w-[30%] mt-[-2.5%] h-full">
          <div className="flex-col gap-14 flex h-full justify-center items-center w-full">
            <div>
              ...
              <p className=" mt-[-20%] font-bold text-orange-500">
                Best burgers <span className="text-red-700">in town</span>
              </p>
            </div>
            <div className="w-[80%]">
            ...
            <form className="w-full">
              <div className="flex w-full items-center flex-col gap-7">
                <div className="flex-col flex w-[80%]">
                  ...
                  <input
                    type="text"
                    className=" w-full border rounded-md h-14 px-4 py-3 focus:outline-none focus:border-blue-500 text-center bg-[#f0efef]"
                    name="username"
            ...
            <p className="text-center text-gray-400 text-sm mx-5 max-md:text-xs w-[80%]">
              First Time Don't worry use the default{' '}
              <span className="text-[#762f33] font-bold">email & password login </span>then you
              can change the password & email.
            </p>
          </div>
        </div>
